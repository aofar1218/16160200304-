...
void TIMER32_0_IRQHandler(void)
{
	...
	LPC_GPIO2->DATA = ~(~LPC_GPIO2->DATA << 1);//这里是用的双取反  因为是共阳极1是灭0是亮 所以最开始赋值是1111 1110取反0000 0001移位0000 0010再取反1111 1101 就是这样  如果不双取反的话直接移位就是从1111 1110 变成1111 1100 移位的初始位是自动补零的
